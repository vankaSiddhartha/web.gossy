...
import {  BsLinkedin, BsPerson, BsTwitterX,BsInstagram} from 'react-icons/bs'
...
fetch('https://gossy-fbbcf-default-rtdb.asia-southeast1.firebasedatabase.app/response.json', {
  ...
  const { hasCopied, onCopy } = useClipboard('infogossy@gmail.com')
          ...
          <VStack spacing={{ base: 4, md: 8, lg: 20 }}>
            ...
            <Stack
              ...
              <Stack
                ...
                <Box as="a" href="https://www.instagram.com/gossylovesyou/">
                  <IconButton
                ...
                <Box as="a" href="https://twitter.com/gossylovesyou">
                  <IconButton
                    aria-label="twitter"
                    variant="ghost"
                    size="lg"
                ...
                <Box as="a" href="https://www.linkedin.com/company/gossy-the-perfect-social-app/about/?viewAsMember=true">
                  <IconButton
                    aria-label="linkedin"
                    variant="ghost"
                    size="lg"
                ...
                <VStack spacing={5}>
                  ...
                  <FormControl isRequired>
                    ...
                    <InputGroup>
                      ...
                      <Input type="email" name="email" placeholder="Your Email" onChange={(e) => {setMail(e.target.value)}} />
                    </InputGroup>
                  </FormControl>
